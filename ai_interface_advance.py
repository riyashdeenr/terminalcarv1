    ...
    def process_command(self, user_input: str, **kwargs) -> str:
        ...
        if not user_input:
            ...
            if not any(term in input_lower for term in allowed_nlp_terms):
                return "Command not recognized. Type 'help' for available commands."            # Process as NLP query with specific scope            try:
                if 'car' in input_lower or 'available' in input_lower or 'vehicle' in input_lower:
                    ...
                    return result
                else:                    return "Command not recognized. Type 'help' for available commands."
            except Exception as e:
